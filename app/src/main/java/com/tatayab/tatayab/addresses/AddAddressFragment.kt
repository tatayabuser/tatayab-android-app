                        ...
                        if (address == null) {
                            if (AsAGuest) {
                                val request = RegisterRequestBody(
                                    ...
                                    o_city = cityName,
                                    o_city_id = if (selectedAreaId > 0 && areaCode.isNullOrBlank().not() &&areaCode.equals(viewModel?.getCountryCode(),true).not() ) selectedCityId.toString() else selectedAreaId.toString(),
                                    ...
                                    o_areaId = if (selectedAreaId > 0 && areaCode.isNullOrBlank().not() &&areaCode.equals(viewModel?.getCountryCode(),true).not() )  selectedCityId.toString() else selectedAreaId.toString(),
